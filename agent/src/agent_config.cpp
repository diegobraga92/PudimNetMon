...
ConfigResult LoadAgentConfig(int argc, char **argv, AgentConfig &out) {
    ...
    out.probe_cfg.dns_targets = std::move(dns_targets);
    out.probe_cfg.tcp_targets = std::move(tcp_targets);
    out.probe_cfg.tls_targets = std::move(tls_targets);
    out.probe_cfg.http_targets = std::move(http_targets);
    out.probe_cfg.ping_targets = std::move(ping_targets);
    out.probe_cfg.http_protocols = std::move(http_protocols);
    out.probe_cfg.dns_expected = std::move(dns_expected);
    out.probe_cfg.ping_count = ping_count;
    out.probe_cfg.ping_gap_ms = ping_gap_ms;
    out.probe_cfg.tls_cert_check = tls_cert_check;
    out.probe_cfg.tcp_retransmit_check = tcp_retransmit_check;
    out.probe_cfg.tcp_handshake_capture = tcp_handshake_capture;
